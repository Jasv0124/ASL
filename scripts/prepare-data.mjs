...
console.log(`Preparados ${result.records.length} registros. Programados: ${result.records.reduce((s,r)=>s+r.scheduled,0)}. Cargados: ${result.records.reduce((s,r)=>s+r.loaded,0)}.`);
